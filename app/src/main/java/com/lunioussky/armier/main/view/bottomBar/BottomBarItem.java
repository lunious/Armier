...
import com.lunioussky.armier.util.UIUtil;
...
public class BottomBarItem extends LinearLayout {
    ...
    public BottomBarItem(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        mTextSize = ta.getDimensionPixelSize(R.styleable.BottomBarItem_itemTextSize, UIUtil.sp2px(mContext, mTextSize));
        ...
        mMarginTop = ta.getDimensionPixelSize(R.styleable.BottomBarItem_itemMarginTop, UIUtil.dip2px(mContext, mMarginTop));
        ...
        mUnreadTextSize = ta.getDimensionPixelSize(R.styleable.BottomBarItem_unreadTextSize, UIUtil.sp2px(mContext, mUnreadTextSize));
        mMsgTextSize = ta.getDimensionPixelSize(R.styleable.BottomBarItem_msgTextSize, UIUtil.sp2px(mContext, mMsgTextSize));
    ...
    public void setUnreadNum(int unreadNum) {
        ...
        if (unreadNum <= 0) {
            ...
            mTvUnread.setText(String.format(Locale.CHINA, "%relax+", unreadNumThreshold));
        }
    }
